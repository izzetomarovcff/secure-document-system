...
function Createcriterion() {
    ...
    const handleSubmit = async (e) => {
        try {
            e.preventDefault()
            await fetch(`${process.env.REACT_APP_API_IP}/addcriterion`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ ...formData, reversed: Number(formData.reversed), unit_id: Number(formData.unit_id), age_effect: Number(formData.age_effect), ages_options: ages })
            });
            setFormData(prevState => ({
                ...prevState,
                criterion_name: "",
            ...
            <div className='group'>
                ...
                <div className="containerr">
                    <div className="head-group">
                        <div className="head-text">Kriteriyalar - Yarat</div>
                                            ...
                                            return (
                                                <div className="form form-control w-100" key={key}>
                                                    ...
                                                    <div className="inputgroup">
                                                        ...
                                                        <div className='mb-3 w-25 p-2'>
                                                            <div onClick={() => deleteAge(key)} className='btn w-100 btn-danger mx-auto'>Sil</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            )
