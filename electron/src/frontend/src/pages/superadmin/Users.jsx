      ...
      <div className='group'>
        ...
        <div className="containerr">
          <div className="head-group">
            ...
            {permissions && permissions.has("add_user")?(<Link to={"/superadmin/users/create"} className="lnk-btn btn btn-secondary">Istifadəçi Yarat</Link>):(<button disabled className="lnk-btn btn btn-secondary">Istifadəçi Yarat</button>)}
          </div>
                    ...
                    return (
                      <tr key={key}>
                        ...
                        <td>
                          ...
                          {permissions && permissions.has("edit_user")?(<Link to={`/superadmin/users/edit/${element.id}`} className='btn btn-sm btn-primary me-3'>Dəyişdir</Link>):(<button disabled className='btn btn-sm btn-primary me-3'>Dəyişdir</button>)}
