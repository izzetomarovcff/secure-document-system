                                        ...
                                        return (
                                            <tr key={key}>
                                                ...
                                                <td>
                                                    ...
                                                    {permissions && permissions.has("view_reciveds") ? (<Link to={`/superadmin/reciveds/view/${element.id}`} className='btn btn-sm btn-primary'>Bax</Link>) : (<button className='btn btn-sm btn-primary' disabled>Bax</button>)}
