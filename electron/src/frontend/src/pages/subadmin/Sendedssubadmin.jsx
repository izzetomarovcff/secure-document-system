      ...
      <div className='group'>
        ...
        <div className="containerr">
          <div className="head-group">
            ...
            {permissions && permissions.has("can_send_document") ? (<Link to={"/subadmin/sendeds/send"} className="lnk-btn btn btn-secondary">Yeni Sənəd Göndər</Link>) : (<button disabled className="lnk-btn btn btn-secondary">Yeni Sənəd Göndər</button>)}
          </div>
                    ...
                    return (
                      <tr key={key}>
                        ...
                        <td>
                          ...
                          {permissions && permissions.has("view_sendeds") ? (<Link to={`/subadmin/sendeds/view/${element.id}`} className='btn btn-sm btn-primary'>Bax</Link>) : (<button className='btn btn-sm btn-primary' disabled>Bax</button>)}
...
export default Sendedssubadmin