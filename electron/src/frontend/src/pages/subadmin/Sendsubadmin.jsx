...
function Sendsubadmin() {
    ...
    const handlesubmit = async (e) => {
        try {
            ...
            window.location.pathname="/subadmin/sendeds"
            ...
            <div className='group'>
                ...
                <div className="containerr">
                    <div className="head-group">
                        ...
                        <Link to={"/subadmin/sendeds"} className="lnk-btn btn btn-danger">Ləğv Et</Link>
                    </div>
